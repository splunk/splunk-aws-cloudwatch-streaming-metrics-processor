...
class SummaryDataPoint(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    class ValueAtQuantile(google___protobuf___message___Message):
        DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
        quantile: builtin___float = ...
        value: builtin___float = ...

        def __init__(self,
            *,
            quantile : typing___Optional[builtin___float] = None,
            value : typing___Optional[builtin___float] = None,
            ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> SummaryDataPoint.ValueAtQuantile: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SummaryDataPoint.ValueAtQuantile: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"quantile",b"quantile",u"value",b"value"]) -> None: ...
    type___ValueAtQuantile = ValueAtQuantile
    ...
    @property
    def quantile_values(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[type___SummaryDataPoint.ValueAtQuantile]: ...
    ...
    def __init__(self,
        *,
        ...
        count : typing___Optional[builtin___int] = None,
        sum : typing___Optional[builtin___float] = None,
        quantile_values : typing___Optional[typing___Iterable[type___SummaryDataPoint.ValueAtQuantile]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
    ...
    def ClearField(self, field_name: typing_extensions___Literal[u"count",b"count",u"labels",b"labels",u"quantile_values",b"quantile_values",u"start_time_unix_nano",b"start_time_unix_nano",u"sum",b"sum",u"time_unix_nano",b"time_unix_nano"]) -> None: ...
